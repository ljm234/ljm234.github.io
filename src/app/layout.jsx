export const metadata = {
  ...
  openGraph: {
    title: "Jordan Montenegro — Clinical ML & Decision Support",
    description: "Clinical ML prototypes with calibration, decision-curve analysis, and safe demos.",
    url: "https://cs-220-portfolio-v3-ljm234.vercel.app",
    siteName: "cs-220-portfolio-v3-ljm234.vercel.app",
    type: "website",
  },
  robots: "index,follow",
};
  ...
  return (
    <html lang="en" className="scroll-smooth">
      ...
      <body className="min-h-screen bg-white text-neutral-900 dark:bg-neutral-950 dark:text-neutral-100">
        <a href="#main" className="sr-only focus:not-sr-only focus:absolute focus:top-2 focus:left-2 bg-yellow-300 text-black px-3 py-1 rounded">Skip to content</a>
...
function ThemeToggle(){return(<button className="rounded border border-neutral-300 dark:border-neutral-700 px-2 py-1 text-sm" onClick={()=>{const el=document.documentElement;const dark=el.classList.toggle("dark");try{localStorage.setItem("theme",dark?"dark":"light")}catch{}}} aria-label="Toggle color theme">Theme</button>);}
